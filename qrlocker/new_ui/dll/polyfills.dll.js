...
// g can still be undefined, but nothing to do login it...
    ...
    var ZoneDelegate = (function () {
        function ZoneDelegate(zone, parentDelegate, zoneSpec) {
            ...
            if (zoneSpecHasTask || parentHasTask) {
                // If we need to report hasTask, than this ZS needs to do ref counting on task. In such
        ...
        ZoneDelegate.prototype._updateTaskCount = function (type, count) {
            ...
            if (next < 0) {
                throw new Error('More task executed then were scheduled.');
            }
            if (prev == 0 || next == 0) {
                var isEmpty = {
 ...
 */
/**
 * Suppress closure compiler errors login unknown 'Zone' variable
 * @fileoverview
